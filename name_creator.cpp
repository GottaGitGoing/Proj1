...
int CreateOutputResult(std::string start,std::string min,std::string max,
                       float start_dis, float min_dis, float max_dis)
{
    std::cout << "Start Location: " << start << " (" << std::to_string(start_dis) << ")" <<std::endl;
    std::cout << "Closest Location: " << min << " (" << std::to_string(min_dist) << ")" << std::endl;
    std::cout << "Farthest Location: " << max << " (" << std::to_string(max_dist) << ")" << std::endl;
